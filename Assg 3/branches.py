#To understand what is a tree structure.
...
#I have roots at the top and leaves at the bottom.

#Looking at the data structure: a tree.

#There is a "root" of all "problems", branching out to bottom.

#Where I am lookig for a specific "problem"

#UNIX file system is a tree, no, like, the thing is litreally
#based off of a tree.

#I can take the entire branch of a sub tree to another sub tree.

#BinaryTree() creates a new instances of a binary tree
